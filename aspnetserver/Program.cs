...
builder.Services.AddCors(options =>
{
    options.AddPolicy("CORSPolicy", 
        builder =>
        {
            ...
            .AllowAnyMethod()
            .AllowAnyHeader()
            .WithOrigins("http://localhost:3000", "https://proud-mushroom-0acaded00.1.azurestaticapps.net");
        });
});
...
{
    swaggerGenOptions.SwaggerDoc("v1", new OpenApiInfo { Title = "ASP.NET React Demo by David", Version = "v1" });
});
...
{
    swaggerUIOptions.DocumentTitle = "ASP.NET React Demo by David";
